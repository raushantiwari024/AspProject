...
var testFiles = ['charsets', 'colors', 'comments', 'css-3', 'strings', 'media', 'mixins'], testSheets = [];
...
for (var i = 0; i < testFiles.length; i++) {
    var file = testFiles[i], lessPath = lessFolder + '/_main/' + file + '.less', cssPath = cssFolder + '/_main/' + file + '.css', lessStyle = document.createElement('style'), cssLink = document.createElement('link'), lessText = '@import "' + lessPath + '";';
...
//# sourceMappingURL=runner-browser-options.js.map